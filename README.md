...
Project source code: [https://github.com/jarviscanada/jarvis_data_eng_BasilSyed](https://github.com/jarviscanada/jarvis_data_eng_BasilSyed)


**Java Grep Application** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_BasilSyed/tree/masterhttps://github.com/jarviscanada/jarvis_data_eng_BasilSyed/tree/develop/core_java)]: Implemented a Java-based grep application to recursively search files using regex. Integrated logging, exception handling, and performance optimizations using Maven and SLF4J.
...
## Education
**Brock University (2021-2025)**, Honours Bachelor of Science in Computer Science, Department of Mathematics and Science
- 4x Dean's Honour List Recipient
- Match of Minds Grant Recipient
